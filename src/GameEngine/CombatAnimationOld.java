...
public class CombatAnimationOld extends Transition {
    ImageView imv;
    int frameNumber;
    ...
    public CombatAnimationOld(Unit unit, String mode, int hitFrame, int frameNumber) throws FileNotFoundException {
