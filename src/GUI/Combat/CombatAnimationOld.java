...
public class CombatAnimationOld extends AnimationTimer {
    ...
    public CombatAnimationOld(CombatRenderer combatRenderer, Unit attacker, Unit defender, ArrayList<String> turn) throws FileNotFoundException {
    ...
    private void loadAttack(Unit attacker, Unit defender, String attack) throws FileNotFoundException {
        String resourceDirectory = attacker.getResourceDirectory().substring(5);
    ...
    private void loadDefense(Unit defender, String defense) throws FileNotFoundException {
        String resourceDirectory = defender.getResourceDirectory().substring(5);
    ...
    public void handle(long l) {
        ...
        if (System.nanoTime() - lastTime > (double)1000000000./60) {
            ...
            if (DefenseAnimations.containsKey(c)) {
                System.out.println(DefenseAnimations.get(c));
