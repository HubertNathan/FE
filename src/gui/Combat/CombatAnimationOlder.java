...
public class CombatAnimationOlder extends Transition {
    ImageView imv;
    int frameNumber;
    ...
    public CombatAnimationOlder(Unit unit, String mode) throws FileNotFoundException {
        String resourceDirectory = unit.getResourceDirectory().substring(5);
    ...
    public CombatAnimationOlder(Unit unit, String mode, int hitFrame, int frameNumber) throws FileNotFoundException {
    ...
    private class battleEffect{
        HashMap<Integer, Image> effectAnimation = new HashMap<>();
        battleEffect(String effect){
            String resourceDirectory = ("file:Resources/FireEmblem/BattleEffects/"+effect+"/"+effect+".txt");
