...
import core.game_engine.save.Save;
...
public class FireEmblemApp extends Application {
    ...
    MenuSelector menuSelector, menuPointer2;
    int month = 1;
    String bloodType = "A";
    String gender = "Male";
    ...
    private void loadMenu(int ID) throws IOException {
        ...
        switch (menuId){
            ...
            case 10:
                ...
                menuSelector.setTranslateX(94*3);
                menuSelector.setTranslateY(43*3);
                menuSelector.play();
                menuPane.getChildren().add(menuSelector);
                break;
            case 11:
                menuPointer2 = new MenuSelector();
        ...
        public void handle(KeyEvent event) {
            ...
            switch (menuId){
                ...
                case 10:
                    switch (event.getCode()){
                        case KeyCode.DOWN:
                            if (menuSelector.getTranslateY() == 43*3) {
                                menuSelector.setTranslateY(76*3);
                                menuSelector.changeTranslateX(99*3);
                            }
                            break;
                        case KeyCode.UP:
                            if (menuSelector.getTranslateY() == 76*3) {
                                menuSelector.setTranslateY(43*3);
                                menuSelector.changeTranslateX(94*3);
                            }
                            break;
                        case KeyCode.LEFT:
                            if (menuSelector.getTranslateY() == 76*3 && menuSelector.getBaseX() == 99*3) menuSelector.changeTranslateX(52*3);
                            else if (menuSelector.getTranslateY() == 76*3 && menuSelector.getBaseX() == 160*3) menuSelector.changeTranslateX(99*3);
                            break;
                        case KeyCode.RIGHT:
                            if (menuSelector.getTranslateY() == 76*3 && menuSelector.getBaseX() == 52*3) menuSelector.changeTranslateX(99*3);
                            else if (menuSelector.getTranslateY() == 76*3 && menuSelector.getBaseX() == 99*3) menuSelector.changeTranslateX(160*3);
                            break;
                        case KeyCode.ENTER:
                            menuSelector.stop();
                            if (menuSelector.getTranslateY() == 43*3){
                            ...
                            else if (menuSelector.getBaseX() == 52 * 3) {
                            ...
                            else if (menuSelector.getBaseX() == 99 * 3) {
                                MainMenuInterface MI;
                                try {
                                    MI = new MainMenuInterface();
                                } catch (IOException e) {
